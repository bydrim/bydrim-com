...
onMounted(() => {
    ...
    isLightTheme.value = currentTheme === LIGHT_THEME;

    watch(isLightTheme, () => {
        let theme = isLightTheme.value ? LIGHT_THEME : DARK_THEME;
...
<template>
    <div class="navbar shadow-md flex-none overflow-hidden z-9999 backdrop-blur-md">
