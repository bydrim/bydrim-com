    ...
    <div class="flex flex-col lg:flex-row justify-evenly items-center">
        ...
        <div class="max-w-4xl">
            ...
            <p class="text-center text-xl mb-6">
                I go by <span class="font-extrabold italic">bydrim</span> online. I am a Software Engineer with a
                passion to achieve
                greatness.
            </p>
            <p class="text-center text-xl mb-6">
            ...
            <p class="text-center text-xl mb-6">
                My website is under heavy development. You can find me from the links below.
            </p>
            <p class="flex flex-row justify-center items-center gap-x-4 my-6">
                <a href="https://github.com/bydrim">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 fill-current" viewBox="0 0 496 512">
                        <path
                ...
                <a href="https://www.linkedin.com/in/yildirim-burak/">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 fill-current" viewBox="0 0 16 16">
                        <path
